...
class ProfileField(StrEnum):
    ...
    SOCIAL_NETWORKS_REQUIRED = "social_networks_required"
    ROAMING_REQUIRED = "roaming_required"
    INTERNATIONAL_CALLS_REQUIRED = "international_calls_required"
    ...
    INVOICING_REQUIRED = "invoicing_required"
    CENTRALIZED_ADMINISTRATION = "centralized_administration"
    CONTACT_ROLE = "contact_role"
    DECISION_PARTICIPATION = "decision_participation"
    CUSTOMER_DECLARED_FINANCING_STATUS = "customer_declared_financing_status"
    LOCATION = "location"
